...
modifier and your Charisma modifier. You can use a Shield and still gain this
benefit.

## Level 3: The Four Humors

You can consciously weaponize your secretions. As a Bonus Action, you can vent one
of the Humors described below, paying its Sorcery Point cost. Each effect uses your
spell save DC.

Each Humor can be vented in two ways: a cheap **Burst** that resolves at once and
...
- **Burst (1 Sorcery Point).** Until the end of your turn, whenever you deal damage
  ...
  (once per spell).
- **Flood (3 Sorcery Points).** For 1 minute, whenever you deal damage with a
...
- **Burst (1 Sorcery Point).** A 15-foot Emanation of slick fluid spreads from you
  ...
  your choice. Each creature of your choice in the area makes a Dexterity saving
  throw, taking your Humoral damage as Bludgeoning damage and gaining the Prone
  condition on a failed save, or half as much damage on a successful one. Until the
  start of your next turn, you also have Advantage on saving throws and ability
  checks to escape or avoid the Grappled and Restrained conditions.
- **Flood (3 Sorcery Points).** A 15-foot Emanation of churning fluid surrounds you
  and moves with you for 1 minute; you are unaffected by it, and the area is
  ...
  there, that creature makes a Dexterity saving throw, taking your Humoral damage as
...
> creature is wearing, the reduction is permanent until the armor is repaired (the
> *Mending* cantrip restores 1 point; a proficient smith working over a Long Rest
...
option is reduced to 2 Sorcery Points.
...
Constitution saving throw. On a failed save, a creature takes 10d6 Acid damage plus
10d6 Poison damage and has the Prone condition; it also has the Poisoned and Blinded
conditions for 1 minute and the Frightened condition until the end of its next turn.
On a successful save, a creature takes half as much damage and has the Prone
condition only.
