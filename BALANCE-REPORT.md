...
- **Offense (O)** — damage and killing control
- **Defense (D)** — AC, resistances, damage reduction, temporary HP
- **Healing (H)** — restoring Hit Points to self or party
- **Utility (U)** — mobility, hard control, versatility, out-of-combat reach

> **Read the average as "how complete," not "how powerful."** A pure blaster that scores
> 1 on Healing is *specialized*, not weak. Well-rounded toolkits rise to the top because
> they refuse to leave a scale empty; dedicated specialists sit lower on average while
> dominating their one axis. The archetype tells you the role; the average tells you the spread.
...
*The average is dragged down for pure blasters that zero out Healing — read Offense and
Utility for their real threat.*
...
| 8 | Soul | Minionmancer / Summoner | 4 | 4 | 1 | 5 | **3.50** | B | **Hold** — keep a firm cap on total Homunculi to save table time. |
...
*Every oath inherits a strong base chassis (Aura of Protection, Divine Smite, Lay on Hands),
so the field clusters tight and high.*

| # | Oath | Archetype | O | D | H | U | Avg | Tier | Verdict |
|---|------|-----------|:-:|:-:|:-:|:-:|:---:|:----:|---------|
| 1 | Blade Master | Reach Smite Duelist | 5 | 4 | 2 | 4 | **3.75** | A | **Nerf** — cap full Divine Smite past short reach, or curb crit-fishing. |
| 2 | Demon Soul | Escalating Demon Bruiser | 5 | 5 | 2 | 3 | **3.75** | A | **Nerf** — cap the Demon Power AC bonus or slow its accrual. |
